(() => {
    ...
    function enhanceDetail(id) {
        ...
        d.className = "ticket-danger";
        d.innerHTML = `<strong>Tindakan berisiko</strong><p>Pembatalan melepaskan reservasi sparepart dan wajib disertai alasan.</p><button class="btn small danger" onclick="openCancel('${id}')">Batalkan tiket</button>`;
        c.appendChild(d);
        mobileActions(id);
    }
